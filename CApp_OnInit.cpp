...
bool CApp::OnInit() {
    ...
    if((Surf_Victory = CSurface::OnLoad("./gfx/winscreen.bmp")) == NULL)
    {
        return false;
    }

    if((Surf_Menu = CSurface::OnLoad("./gfx/MainMenu.bmp")) == NULL)
    {
        return false;
    }
    ...
    CSurface::Transparent(Surf_Victory, 0, 0, 0);
    CSurface::Transparent(Surf_Menu, 0, 0, 0);
